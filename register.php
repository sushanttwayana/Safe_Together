...
<body>
    ...
    <div class="form-container">
        <header> 
    <h1 style="color: white;">Safe Together</h1>

           </header>
<h3>Registration Form</h3>
        <!-- Customer Information -->
        <form name ="myform" action="insertuser.php" enctype="multipart/form-data" method="POST" onsubmit="return validateform()">
                ...
                <div class="details personal">
                    ...
                    <div class="fields">
                        ...
                        <div class="input-field">
                            ...
                            <input type="password" name="cpw" placeholder="Confirm your password">
                        </div>
                        
                        <div class="input-field">
                            <label>Emergency Contact</label>
                            <input type="number" name="econtact1" id ="number" placeholder="Enter Emergency contact" required>
                        </div>

                        <div class="input-field">
                            <label>Emergency Contact (optional)</label>
                            <input type="number" name="econtact2" id ="number" placeholder="Enter Emergency contact" >
                        </div>
                    ...
                    <div class="fields"> 
                        <div class="input-field">
                            ...
                            <input type="text" name="street" placeholder="Enter your resident address">
                        </div>
                        ...
                        <div class="fields"> 
                            ...
                            <div class="input-field" >
                                ...
                                <input type="text" placeholder="Blood Group" name="bg" required>
                            </div>
                            <div class="input-field">
                                <label>Allergies</label>
                                <input type="text" placeholder="Enter if allergy present" name="allergy" onkeypress="return (event.charCode > 64 && 
                                event.charCode < 91) || (event.charCode > 96 && event.charCode < 123)" >
                            </div>
                            <div class="input-field">
                                <label>Current Medication (if any)</label>
                                <input type="text" placeholder="Enter current ongoing medication" name="medication" >
                            </div>
<!--     
                            <div class="input-field">
