...
<body>
    ...
    $sql = "SELECT * FROM user WHERE user_id = $id "; // Employee_ID  = ".$id;
    ...
    <div class="container">
        <header>Update Rescue Team</header>

        <form action="updaterescue.php" method="POST">
                ...
                <div class="details personal">
                    ...
                    <div class="fields">
                        ...
                        <div class="input-field">
                            ...
                            <input type="text"  name="rescue" placeholder="Enter rescue team" value=" <?php global $rescue; echo $rescue ?>" required>
                        </div>
